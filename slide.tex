...
\begin{frame}{Kết quả thực nghiệm}
    \begin{figure}[h!]
        \centering
        \includegraphics[scale=0.45]{cifar10_sn_ddpm_cs.png}
        \caption{Một số ảnh được sinh từ quá trình huấn luyện SN-DPM trên tập CIFAR10 với lịch trình phương sai CS.}
    \end{figure}
\end{frame}
